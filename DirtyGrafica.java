...
public class DirtyGrafica extends JFrame{

	DirtyGrafica(){
	  setSize(320, 430);
      setTitle("Gráfica lineal");
      setVisible(true);
      setResizable(false);
      ...
      JLabel title = new JLabel("GRÁFICAR LINEAL");
      ...
      Graficar.addActionListener(new ActionListener() {
			 public void actionPerformed(ActionEvent arg0) {
			        ...
			        grafico = ChartFactory.createLineChart("GRÁFICA LINEAL", "DIAS", "GANANCIAS",datos ,PlotOrientation.VERTICAL, true, true, false);
	...
	public static void main(String[]args) {
		...
		new DirtyGrafica().setVisible(true);
