...
public class GraficaPastelDirty  extends JFrame{
	GraficaPastelDirty(){
		  setSize(320, 430);
	      ...
	      JLabel title = new JLabel("GRÁFICA DE PASTEL");
	      ...
	      Graficar.addActionListener(new ActionListener() {
				 public void actionPerformed(ActionEvent arg0) {
			            ...
			            datosPie.setValue("LUNES", dato1);
			            datosPie.setValue("MARTES", dato2);
			            datosPie.setValue("MIÉRCOLES", dato3);
			            datosPie.setValue("JUEVES", dato4);   
			            datosPie.setValue("VIERNES",dato5);
			            datosPie.setValue("SÁBADO",dato6);
			            datosPie.setValue("DOMINGO",dato7);
		...
		public static void main(String[]args) {
			...
			new GraficaPastelDirty().setVisible(true);
